...
/**
 * Adjacency Map Graph - Implementation of the Graph interface.
...
public class AdjacencyMapGraph<V, E> implements Graph<V, E>
{
    ...
    public int numEdges()
    {
        // We do not actually keep an edge list around, so we compute this on the fly.
        int n = 0;
    ...
    public void removeVertex(V v)
    {
        ...
        for (V w : outNeighbors(v))
        {
            // w has an edge from v.
            in.get(w).remove(v);
        }
